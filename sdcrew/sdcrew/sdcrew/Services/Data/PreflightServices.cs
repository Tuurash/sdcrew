    ...
    public class PreflightServices
    {
        ...
        public async Task InsertDatas()
        {
            ...
            await Task.WhenAll(t1, t2, t3, t4)
                .ContinueWith(async x=> await AddStaffEventTypes())
        ...
        public async Task<IEnumerable<FlightCrewMember>> GetCrewMembers(int aircraftId, int LegNumber, int FlightId, int ScheduledAircraftTripId) //
        {
            await Task.Delay(1);
        ...
        public async Task<IEnumerable<FlightPassenger>> GetPassengers(int aircraftId, int LegNumber, int FlightId, int ScheduledAircraftTripId)
        {
            await Task.Delay(1);
        ...
        public async Task AddServices_Preflight(int ScheduledFlightId)
        {
            ...
            var aircraftServices = await _preflightRepo.GetAircraftServices(27638).ConfigureAwait(false);  //ScheduledFlightId //27638
